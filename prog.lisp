; 5
;ќпределите функцию, котора€ увеличивает
...
; 7
; ќпределите функцию, удал€ющую из исходного 
...
; 11
; ќпределите функцию, осуществл€ющую разделение
;исходного списка на два подсписка. 
; ¬ первый из них должно попасть указанное количество элементов
...
; 12
;ќпределите функцию, замен€ющую 
;в исходном списке два подр€д
...
; 13. ќпределите функцию, удал€ющую 
; в исходном списке все повторные вхождени€ элементов.
; (1 1 1) -> (1)
...
; 19
; ќпределите функцию (Ћ” ќ¬»÷ј n), 
; стро€щую N-уровневый вложенный список, 
;элементом которого на самом глубоком уровне €вл€етс€ N.
; 4 -> ((((4))))
...
; 31. ќпределите функцию (ѕ≈–¬џ…-—ќ¬ѕјƒјёў»… х у), 
; котора€ возвращает первый элемент, 
; вход€щий в оба списка х и у, в противном случае NIL.
; (1 3 3) (2 6 0) -> nil
; (1 3 3) (1 6 0) -> 1
(defun p(a l) 
    (cond 
